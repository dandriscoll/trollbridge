...
- **Windows or direct download.** Grab
  [`trollbridge_v0.7.17_linux_amd64.tar.gz`](https://github.com/dandriscoll/trollbridge/releases/download/v0.7.17/trollbridge_v0.7.17_linux_amd64.tar.gz)
  ...
  `sudo install -m 0755 trollbridge_v0.7.17_linux_amd64/trollbridge /usr/local/bin/trollbridge`.
